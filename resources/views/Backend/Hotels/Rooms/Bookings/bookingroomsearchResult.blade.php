                            ...
                            <table id="datatables-example" class="table table-striped table-bordered"
                                ...
                                <form action="" method="post">
                                    @forelse($search as $sea)
                                        <tr>
                                            <td>{{$sea->id}}</td>
                                            <td><input type="hidden" name="bookingTours_tour_id"
                                                       value="{{$sea->tour_id}}"> {{$sea->tour_id}}</td>
                                            <td><input type="hidden" name="tours_itinerary"
                                                       value="{{$sea->itinerary}}">{{$sea->itinerary}}</td>
                                            <td><input type="hidden" name="bookingTours_start_date"
                                                       value="{{$sea->start_date}}">{{$sea->start_date}}</td>
                                            <td><input type="hidden" name="bookingTours_end_date"
                                                       value="{{$sea->end_date}}">{{$sea->end_date}}</td>
                                            <td><input type="hidden" name="bookingTour_no_of_people"

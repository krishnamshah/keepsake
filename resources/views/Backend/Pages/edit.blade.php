                    ...
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('pages.update',$page->id)}}">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="page_title" value="{{$page->title}}">
                                <span class="bar"></span>
                                <label>Page Title</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <textarea type="text" class="form-text" required name="page_description">{{$page->description}}</textarea>
                                <span class="bar"></span>
                                <label>Page Description</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <textarea type="text" class="form-text" required name="page_parent_page">{{$page->parent_page}}</textarea>
                                <span class="bar"></span>
                                <label>Parent Page</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="page_slug" value="{{$page->slug}}">
                                <span class="bar"></span>

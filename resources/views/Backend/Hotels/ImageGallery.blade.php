...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('BackendTheme/asset/css/plugins/dropzone.css')}}"/>
@endsection
        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">{{$hotel->name}}</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    @forelse($hotel_Images as $images)
                        <div class="col-sm-6 col-md-3 product-grid">
                            <div class="thumbnail">

                                <img style="width: 250px; height: 250px;" alt="250x250"
                                     src=@if (Storage::disk('public')->has($images->image))
                                             "{{Storage::url($images->image) }}" @endif
                                     data-src=@if (Storage::disk('public')->has($images->image))
                                        "{{Storage::url($images->image) }}" @endif data-holder-rendered="true">
                                <div class="caption">

                                    <p><a class="btn btn-danger" role="button"
                                          href="{{route('delete.hotel.image',$images->id)}}"
                                          onclick="(alert('Do you wish to delete'))">Remove me</a></p>
                                </div>
                            </div>
                        </div>

                    @empty
                        Sorry Gallery is empty now. Please add some image into it.
                    @endforelse
                </div>
            </div>
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-offset-1 col-md-10">
                        <div class="jumbotron how-to-create">
                            ...
                            <h3>Add Image to gallery<span id="photoCounter"></span></h3>
                            <br/>

                            {!! Form::open(['url' => route('hotels.images.addgallery'), 'class' => 'dropzone', 'files'=>true, 'id'=>'real-dropzone']) !!}
...
@section('script')
    ...
    <script src="{{URL::asset('BackendTheme/asset/js/plugins/dropzone.js')}}"></script>
    <!-- custom -->

...
@section('content')
    ...
    <div class="container">
        <form class="row" method="post" action="{{route('tour.savebooking',[$tour->id])}}">
            {{ csrf_field() }}
            <div class="col-md-8">
                <h3>Customer</h3>
            ...
            <div class="col-md-4">
                <div class="booking-item-payment">
                    <header class="clearfix">
                        <div class="booking-item-payment-img">
                            @if (Storage::disk('public')->has($tour->image))
                                <img src="{{Storage::URL($tour->image)}}" class="" width="300px" height="100px"/>
                            @endif
                        </div>
                        <h5 class="booking-item-payment-title"><a href="#">{{ $tour->name }}</a></h5>
                    ...
                    <ul class="booking-item-payment-details">
                        ...
                        <li>
                            <h5>Room</h5>
                            <p class="booking-item-payment-item-title">{{ $tour['name'] }}</p>
                            <ul class="booking-item-payment-price">
                                <li>
                                    <p class="booking-item-payment-price-title">Cost</p>
                                    <p class="booking-item-payment-price-amount">{{ $tour['tour_cost'] }}
                                        <small>/per day</small>
                                    </p>
                                </li>
                                <li>
                                    <p class="booking-item-payment-price-title">Cost Per Extra Bed</p>
                                    <p class="booking-item-payment-price-amount">{{ $tour['cost_per_extra_bed'] }}
                                        <small>/per day</small>
                                    </p>
                                </li>
                            </ul>

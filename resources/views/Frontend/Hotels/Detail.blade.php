                                ...
                                <!-- START LIGHTBOX GALLERY -->
                                    ...
                                    <div class="row row-no-gutter" id="popup-gallery">
                                        @forelse($hotelGallery as $image)
                                            <div class="col-md-2">
                                                <a class="hover-img popup-gallery-image" href="{{'/public'.Storage::url($image->image)}}" data-effect="mfp-zoom-out">
                                                    <img src="{{'/public'.Storage::url($image->image)}}" alt="Image Alternative text" title="hotel EDEN MAR suite"><i class="fa fa-plus round box-icon-small hover-icon i round"></i>
                                                </a>
                                            </div>
                                        @empty
                    ...
                    <ul class="booking-list">
                        <li>
                            <a class="booking-item">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="img\lhotel_porto_bay_sao_paulo_lobby_800x600.jpg"
                                             alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby">
                                    </div>
                                    <div class="col-md-6">
                                        <h5 class="booking-item-title">Standard Double room</h5>
                                        <p class="text-small">Pellentesque mattis iaculis felis tempus tristique metus
                                        ...
                                        <ul class="booking-item-features booking-item-features-sign clearfix">
                                            <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i
                                                        class="fa fa-male"></i><span class="booking-item-feature-sign">x 2</span>
                                            </li>
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Beds"><i
                                                        class="im im-bed"></i><span class="booking-item-feature-sign">x 1</span>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i
                                                        class="im im-width"></i><span class="booking-item-feature-sign">460</span>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="col-md-3"><span
                                                class="booking-item-price">$357</span><span>/night</span><span
                        ...
                        <li>
                            <a class="booking-item">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="img\hotel_porto_bay_rio_internacional_rooftop_pool_800x600.jpg"
                                             alt="Image Alternative text"
                                             title="hotel PORTO BAY RIO INTERNACIONAL rooftop pool">
                                    </div>
                                    <div class="col-md-6">
                                        <h5 class="booking-item-title">Superior Penthouse</h5>
                                        <p class="text-small">Hendrerit erat curae blandit consectetur rutrum sapien
                                            eleifend sodales montes rhoncus sagittis orci</p>
                                        <ul class="booking-item-features booking-item-features-sign clearfix">
                                            <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i
                                                        class="fa fa-male"></i><span class="booking-item-feature-sign">x 2</span>
                                            </li>
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i
                                                        class="im im-width"></i><span class="booking-item-feature-sign">420</span>
                                            </li>
                                        </ul>
                                        <ul class="booking-item-features booking-item-features-small clearfix">
                                            <li rel="tooltip" data-placement="top" title="Air Conditioning"><i
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Mini Bar"><i
                                                        class="im im-bar"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Bathtub"><i
                                                        class="im im-bathtub"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Patio"><i
                                                        class="im im-patio"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="SPA tub"><i
                                                        class="im im-spa"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Terrace"><i
                                                        class="im im-terrace"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Washing Machine"><i
                                                        class="im im-washing-machine"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Pool"><i
                                                        class="im im-pool"></i>
                                            </li>
                                    ...
                                    <div class="col-md-3"><span
                                                class="booking-item-price">$365</span><span>/night</span><span
                                                class="btn btn-primary">Book</span>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="booking-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="text-small">Quis ullamcorper potenti condimentum cras neque luctus
                                            felis turpis nostra arcu tempus rutrum</p>
                                        <ul class="booking-item-features booking-item-features-sign clearfix">
                                            <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i
                                                        class="fa fa-male"></i><span class="booking-item-feature-sign">x 3</span>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Children Occupancy"><i
                                                        class="im im-children"></i><span
                                                        class="booking-item-feature-sign">x 2</span>
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i
                                                        class="im im-width"></i><span class="booking-item-feature-sign">360</span>
                                            </li>
                                        </ul>
                                        <ul class="booking-item-features booking-item-features-small clearfix">
                                            <li rel="tooltip" data-placement="top" title="Air Conditioning"><i
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Kitchen"><i
                                                        class="im im-kitchen"></i>
                                            </li>
                                            <li rel="tooltip" data-placement="top" title="Patio"><i
                                                        class="im im-patio"></i>
                                            </li>
                                    ...
                                    <div class="col-md-3"><span
                                                class="booking-item-price">$192</span><span>/night</span><span
                                                class="btn btn-primary">Book</span>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a class="booking-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="text-small">Hac ullamcorper torquent volutpat pellentesque adipiscing
                                            ut elementum sollicitudin sodales congue quam rutrum</p>
                                        <ul class="booking-item-features booking-item-features-sign clearfix">
                                            <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i
                                                        class="fa fa-male"></i><span class="booking-item-feature-sign">x 2</span>
                                            </li>
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i
                                                        class="im im-width"></i><span class="booking-item-feature-sign">610</span>
                                            </li>
                                        </ul>
                                        <ul class="booking-item-features booking-item-features-small clearfix">
                                            <li rel="tooltip" data-placement="top" title="Flat Screen TV"><i
                                    ...
                                    <div class="col-md-3"><span
                                                class="booking-item-price">$410</span><span>/night</span><span
                                                class="btn btn-primary">Book</span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li>
                            <a class="booking-item">
                                <div class="row">
                                    <div class="col-md-3">
                                        <img src="img\the_pool_800x600.jpg" alt="Image Alternative text"
                                             title="The pool">
                                    </div>
                                    <div class="col-md-6">
                                        <h5 class="booking-item-title">Family Suite</h5>
                                        <p class="text-small">Habitant accumsan elit scelerisque accumsan proin varius
                                            purus scelerisque taciti nam venenatis diam</p>
                                        <ul class="booking-item-features booking-item-features-sign clearfix">
                                            <li rel="tooltip" data-placement="top" title="Adults Occupancy"><i
                                                        class="fa fa-male"></i><span class="booking-item-feature-sign">x 2</span>
                                            </li>
                                            ...
                                            <li rel="tooltip" data-placement="top" title="Room footage (square feet)"><i
                                                        class="im im-width"></i><span class="booking-item-feature-sign">410</span>
                                            </li>
                                        </ul>
                                        <ul class="booking-item-features booking-item-features-small clearfix">
                                            <li rel="tooltip" data-placement="top" title="Flat Screen TV"><i
                                    ...
                                    <div class="col-md-3"><span
                                                class="booking-item-price">$174</span><span>/night</span><span
                                                class="btn btn-primary">Book</span>
                                    </div>
                                </div>
                            </a>

            ...
            <div class="col-md-12">
                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('tours.update',$booking->id)}}">
                            @csrf
                            @php
                                $no_of_people=2;
                            @endphp
                            @if($no_of_people>1)
                                ...
                                @for($i=0;$i<$no_of_people;$i++)
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_traveller_name"  value="{{$tour->name}}">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group" style="margin-top:40px !important;">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-12">
                                                <select class="select2-A" name="bookingVehicle_traveller_gender[]">
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_dob" value="{{$tour->dob}}">
                                        <span class="bar"></span>
                                        <label>Traveller's Date of Birth</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_phone_no">
                                        <label>Traveller's Contact No.</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_address">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        ...
                                        <span class="bar"></span>
                                        <label>Traveller's Email-ID</label>
                                    </div>
                            ...
                            @else{
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="bookingTour_traveller_name">
                                <span class="bar"></span>
                                <label>Traveller's Name</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="bookingTour_dob">
                                <span class="bar"></span>
                                <label>Traveller's Date of Birth</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        ...
                        {{--<form method="post" enctype="multipart/form-data" action="{{route('bookingsTour.save')}}">--}}
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                                  name="bookingTour_phone_no"></input>
                                <span class="bar"></span>

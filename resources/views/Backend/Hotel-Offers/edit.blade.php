            ...
            <div class="col-md-12">
                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <div class="form-element">
                            <div class="col-md-12 padding-0">
                                <form method="post" enctype="multipart/form-data" action="{{route('HotelsOffer.update')}}">
                                    @csrf
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="hidden" class="form-text" required name="hotel_offer_id"
                                        value="{{$offer->id}}">
                                        <input type="text" class="form-text" required name="hotel_offer_title" value="{{$offer->offername}}">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <textarea type="text" class="form-text" required
                                                  name="hotel_offer_description">{{$offer->description}}</textarea>
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text">
                                        <input class="form-text dateAnimate" required="" data-dtp="dtp_g91iZ"
                                               type="text" name="hotel_offer_start_date" value="{{$offer->offer_start_date}}">
                                        <span class="bar"></span>
                                        <label><span class="fa fa-calendar"></span> Hotel Offer Start Date</label>
                                    </div>
                                    <div class="form-group form-animate-text">
                                        <input class="form-text dateAnimate" required="" data-dtp="dtp_g91iZ"
                                               type="text" name="hotel_offer_end_date" value="{{$offer->offer_end_date}}">
                                        <span class="bar"></span>

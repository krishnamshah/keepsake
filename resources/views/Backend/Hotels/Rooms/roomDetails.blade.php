        ...
        <div class="col-md-12 col-sm-12 profile-v1-wrapper">
            <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                <div class="profile-v1-pp">
                    <img src="{{URL::to('storage/'.$room->image)}}" class="img-responsive"/>
                    <h2>{{$room->name}}</h2>
                                ...
                                <div class="panel-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Hotel Id</h5>
                                            {{$room->hotel_id}}
                                        </div>
                                    </div>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Room Type ID</h5>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Max Extra bed Uptp</h5>
                                            {{ $room->max_extra_bed_up}}
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Cost</h5>
                                            {{$room->room_cost}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Cost Per Extra Bed</h5>
                                            {{$room->cost_per_extra_bed}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">No Of Rooms</h5>
                                            {{$room->no_of_rooms}}
                                        </div>
                                    </div>

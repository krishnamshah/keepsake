        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group form-group-icon-left"><i
                    ...
                    <label>From</label>
                    <input class="typeahead form-control" value="Great Britan, London"
            ...
            <div class="col-md-3">
                <div class="form-group form-group-icon-left"><i
                            class="fa fa-map-marker input-icon input-icon-hightlight"></i>
                    <label>To</label>
                    <input class="typeahead form-control" value="United States, New York"
                           placeholder="City, Hotel Name or U.S. Zip Code" type="text">
                </div>
            </div>
            <div class="col-md-2">
            ...
            <aside class="booking-filters text-white">
                ...
                <ul class="list booking-filters-list">
                    ...
                    <li>
                        ...
                        <div class="checkbox">
                            <label>
                                <input class="i-check" type="checkbox">American Airlines<span
                                        class="pull-right">$350</span>
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                        ...
                        <div class="checkbox">
                            <label>
                                <input class="i-check" type="checkbox">Croatia Airlines<span
                                        class="pull-right">$197</span>
                            </label>
                        </div>
                        <div class="checkbox">
                            <label>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="booking-item-flight-details">
                                        <div class="booking-item-departure"><i class="fa fa-plane"></i>
                                            ...
                                            <p class="booking-item-destination">London, England, United Kingdom
                                                (LHR)</p>
                                        </div>
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$344</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary"
                                                                                            href="#">Select</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$427</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: Economy</p><a class="btn btn-primary"
                                                                                              href="#">Select</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$286</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary"
                                                                                            href="#">Select</a>
                                </div>
                            </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$210</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: Economy</p><a class="btn btn-primary"
                                                                                              href="#">Select</a>
                                </div>
                            </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$175</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary"
                                                                                            href="#">Select</a>
                                </div>
                            </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$306</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: Business</p><a class="btn btn-primary"
                                                                                               href="#">Select</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$354</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary"
                                                                                            href="#">Select</a>
                                </div>
                            </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$301</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: Economy</p><a class="btn btn-primary"
                                                                                              href="#">Select</a>
                                </div>
                            </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$378</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: Business</p><a class="btn btn-primary"
                                                                                               href="#">Select</a>
                                </div>
                            </div>
                    ...
                    <div class="booking-item-container">
                        <div class="booking-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><span class="booking-item-price">$442</span><span>/person</span>
                                    <p class="booking-item-flight-class">Class: First</p><a class="btn btn-primary"
                                                                                            href="#">Select</a>
                                </div>
                            </div>

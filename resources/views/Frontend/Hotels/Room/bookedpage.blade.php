    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <h5 class="text-center ">To email to {{$datas['booked_by']->email}} ::: <a class="btn btn-primary" href="{{route('hotel.sendemail',[$datas['booked_by']->email])}}"> Click Here!!</a></h5>
                ...
                <ul class="order-payment-list list mb30">
                    <li>
                        <div class="row">
                            <div class="col-xs-9">
                                <h4><i class="fa fa-building"></i>{{$datas['hotel']->hotel_name}} </h4>
                                <h6 class="mb10"><i class="fa fa-inbox"></i> {{$datas['hotel']->street}},{{$datas['hotel']->city}}
                                    ,{{$datas['hotel']->province}}</h6>
                                <h6><i class="fa fa-inbox"></i> Room Name: {{$datas['room']->name}}</h6>
                ...
                <ul class="list list-inline list-center">
                    ...
                    <li><a class="btn btn-primary" href="#"><i class="fa fa-bolt"></i> Tours</a></li>
                </ul>
            </div>
        </div>
        <div class="gap"></div>

            ...
            <div class="col-md-12">
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('bookingsRoom.save')}}">
                            @csrf
                            <input type="hidden" value="{{$id}}" name="booking_room_id">
                            <input type="hidden" value="{{$start_date}}" name="booking_room_start_date">
                            <input type="hidden" value="{{$location_city}}" name="booking_room_location_city">
                            <input type="hidden" value="{{$end_date}}" name="booking_room_end_date">
                            <input type="hidden" value="{{$no_of_people}}" name="booking_room_no_of_people">
                                ...
                                @for($i=0;$i<$no_of_people;$i++)
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                               name="bookingRoom_traveller_name[]">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <textarea type="text" class="form-text" required
                                                  name="bookingRoom_traveller_dob[]"></textarea>
                                        <span class="bar"></span>
                                        <label>Traveller's Date of Birth</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <textarea type="text" class="form-text" required
                                                  name="bookingRoom_traveller_phone_no[]"></textarea>
                                        <span class="bar"></span>
                                        <label>Traveller's Contact No.</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                               name="bookingRoom_traveller_address[]">
                                        <span class="bar"></span>
                            ...
                            @else
                                You must have at leat a traveller.
                        @endif
                        <!-- Booked By -->
                            <hr/>
                            <h2>Booked By :</h2>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="bookingRoom_booking_done_by">
                                <span class="bar"></span>
                                <label>Name:</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <textarea type="text" class="form-text" required
                                                  name="bookingRoom_phone_no"></textarea>
                                <span class="bar"></span>
                                <label>Contact No.</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="bookingRoom_email">
                                <span class="bar"></span>

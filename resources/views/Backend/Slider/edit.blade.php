                    ...
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('slider.update',$slider->id)}}">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="slider_title" value="{{$slider->title}}">>
                                <span class="bar"></span>
                                <label>Slider Title</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="slider_link" value="{{$slider->link}}">
                                <span class="bar"></span>
                                <label>Slider Link</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <textarea type="text" class="form-text" required name="slider_description">{!! $slider->description !!}</textarea>
                                <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                ...
                                @if (Storage::disk('public')->has($slider->image))
                                    <img src="{{Storage::url($slider->image) }}" class="" width="300px"
                                         height="100px"/>
                                @endif
                            </div>

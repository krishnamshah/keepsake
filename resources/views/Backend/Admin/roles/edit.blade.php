        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:10px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Edit {{$role->display_name}} !!!</h3>
            ...
            <div class="col-md-12 padding-0">
                ...
                <form action="{{route('roles.update', $role->id)}}" method="POST">
                    ...
                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        ...
                        <span class="bar"></span>
                        <label>Name (HumanReadable)</label>
                    </div>

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">

                        <input type="text" class="input" name="name"
                               value="{{$role->name}}" disabled id="name">
                        <span class="bar"></span>
                        <label>Slug (Can not be edited)</label>
                    </div>
                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input type="text" class="input" value="{{$role->description}}"
                               id="description" name="description"> <span class="bar"></span>
                    ...
                    <div class="col-md-12">
                        @forelse($permissions as $permission)
                            ...
                            <input type="checkbox" value="{{$permission->id}}" }}
                                   name="permissions[]">
                            {{$permission->display_name}} <em>({{$permission->description}}
                                )</em>
                        @empty
                            Sorry No permission Are avilable
                        @endforelse
                    </div> <!-- end of .box -->

                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <button class="submit btn btn-success">Update Roles</button>
                    </div>

                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="patch" enctype="multipart/form-data"
                              action="{{route('hotels.room.services.update',$service->id)}}">
                            @csrf
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                ...
                                <div class="form-animate-radio">
                                    <label class="radio">
                                        <input id="radio1" name="hotel_service_type" type="radio" value="free" {{($service->service_type=='free')?"Checked":"" }} >
                                        <span class="outer">
                              <span class="inner"></span></span> Free
                                    </label>
                                    <label class="radio">
                                        <input id="radio1" name="hotel_service_type" type="radio"  value="paid" {{($service->service_type=='paid')?"Checked":"" }}>
                                        <span class="outer">
                              <span class="inner"></span></span> Paid
                                    </label>
                                </div>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="hotel_service_cost" value="{{$service->cost}}">
                                <span class="bar"></span>
                                <label>Service Cost if Any</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="hotel_service_cost_unit" value="{{$service->unit}}">
                                <span class="bar"></span>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                ...
                                <div class="form-animate-radio">
                                    <label class="radio">
                                        <input id="radio1" name="hotel_service_enable" type="radio" value="1"  {{($service->enable==1)?"Checked":"" }}>
                                        <span class="outer">
                              <span class="inner"></span></span> Enable
                                    </label>
                                    <label class="radio">
                                        <input id="radio1" name="hotel_service_enable" type="radio"  value="0" {{($service->enable==0)?"Checked":"" }}>
                                        <span class="outer">
                              <span class="inner"></span></span> Disable
                                    </label>
                                </div>

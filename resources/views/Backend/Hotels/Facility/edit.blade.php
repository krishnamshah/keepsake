                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="patch" enctype="multipart/form-data"
                              action="{{route('hotels.facilities.update',$facility->id)}}">
                            @csrf
                                <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                    <input type="text" class="form-text" required name="hotel_name" value="{{$facility->title}}">
                                    <span class="bar"></span>
                                    <label>Hotel Facility Title</label>
                                </div>
                                <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                    <input type="text" class="form-text" required name="hotel_contact_person" value="{{$facility->description}}">
                                    <span class="bar"></span>
                                    <label>Description</label>
                                </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">

                                    <input type="checkbox" name="hotel_facility_enable"  {{($facility->enable==1)?"checked":""}}>

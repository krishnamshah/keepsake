...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('BackendTheme/asset/css/plugins/ionrangeslider/ion.rangeSlider.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{URL::asset('BackendTheme/asset/css/plugins/ionrangeslider/ion.rangeSlider.skinFlat.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{URL::asset('BackendTheme/asset/css/plugins/bootstrap-material-datetimepicker.css')}}"/>
@endsection
@section('content')
        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Edit Tour Details</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('tours.update',$tour->id)}}">
                            @csrf
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_name" value="{{$tour->name}}">
                                <span class="bar"></span>
                                <label>Tour Name</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_description" value="{{$tour->description}}">
                                <span class="bar"></span>
                                <label>Tour Descriptions</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_itineary" value="{{$tour->itinery}}">
                                <span class="bar"></span>
                                <label>Tour Itineary</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_tag" value="{{$tour->tag}}">
                                <span class="bar"></span>
                                <label>Tour Tag</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_duration" value="{{$tour->duration}}">
                                <span class="bar"></span>
                                <label>Tour Duration</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_price" value="{{$tour->price}}">
                                <span class="bar"></span>
                                <label>Rate Per Person</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_group_rate" value="{{$tour->group_rate}}">
                                <span class="bar"></span>
                                <label>Rate Per Group</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_bestime" value="{{$tour->best_time}}">
                                <span class="bar"></span>
                                <label>Best Time</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="tour_group_size" value="{{$tour->group_size}}">
                                <span class="bar"></span>

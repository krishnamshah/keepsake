...
@section('content')
    ...
    <div id="content">
        ...
        <hr>
        <div class="col-md-12" style="padding:20px; color:black;">
    ...
    @section('script')
        <!-- plugins -->
            ...
            <script src="{{URL::asset('BackendTheme/asset/js/plugins/fullcalendar.min.js')}}"></script>
            <script src="{{URL::asset('BackendTheme/asset/js/plugins/jquery.nicescroll.js')}}"></script>
            <script src="{{URL::asset('BackendTheme/asset/js/plugins/jquery.vmap.min.js')}}"></script>
            <script src="{{URL::asset('BackendTheme/asset/js/plugins/maps/jquery.vmap.world.js')}}"></script>
            <script src="{{URL::asset('BackendTheme/asset/js/plugins/jquery.vmap.sampledata.js')}}"></script>
            <script src="{{URL::asset('BackendTheme/asset/js/plugins/chart.min.js')}}"></script>

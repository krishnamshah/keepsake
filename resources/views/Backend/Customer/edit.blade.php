        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Edit Customer Agent Details</h3>
                    ...
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('customer.update',$customer->id)}}">
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_name" value="{{$customer->name}}">
                                <span class="bar"></span>
                                <label>Customer Name</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_id_no" value="{{$customer->id_no}}">
                                <span class="bar"></span>
                                <label>Id No</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_id_type" value="{{$customer->id_type}}">
                                <span class="bar"></span>
                                <label>Id Type</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_id_isued_by" value="{{$customer->issued_by}}">
                                <span class="bar"></span>
                                <label>Id Issuded By</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_country" value="{{$customer->country}}">
                                <span class="bar"></span>
                                <label>Country</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_city" value="{{$customer->city}}">
                                <span class="bar"></span>
                                <label>City</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_resident_no" value="{{$customer->resident_no}}">
                                <span class="bar"></span>
                                <label>Resident Phone</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="customer_cell" value="{{$customer->cell}}">
                                <span class="bar"></span>
                                <label>Cell </label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="email" class="form-text" required name="customer_email" value="{{$customer->email}}">
                                <span class="bar"></span>
                                <label>Email</label>
                            </div>

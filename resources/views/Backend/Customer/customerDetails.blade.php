        ...
        <div class="col-md-12 col-sm-12 profile-v1-wrapper">
            <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                <div class="profile-v1-pp">
                    <img src="{{URL::to('storage/'.$customer->image)}}" class="img-responsive"/>
                    <h2>{{$customer->name}}</h2>
                        ...
                        <div class="col-md-12 padding-0 box-v7-header">
                            <div class="col-md-12 padding-0">
                                <div class="col-md-10 padding-0">
                                    <img src="{{URL::to('storage/'.$customer->image)}}"
                                ...
                                <div class="panel-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Id No</h5>
                                            {{$customer->id_no}}
                                        </div>
                                    </div>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Id Type</h5>
                                            {{$customer->id_type}}
                                        </div>
                                    </div>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Id Issued By</h5>
                                            {{ $customer->issued_by}}
                                        </div>
                                    </div>
                                    <div class="media">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Resident Telephone</h5>
                                            {{$customer->resident_no}}
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Cell</h5>
                                            {{$customer->cell}}
                                        </div>
                                    </div>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Customer Email</h5>
                                            {{ $customer->email}}
                                        </div>
                                    </div>

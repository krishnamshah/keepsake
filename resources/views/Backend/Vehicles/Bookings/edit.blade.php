        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Edit Vehicle Details</h3>
                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('Vehicles.update',$Vehicle->id)}}">
                            @csrf
                            @if(count($no_of_people)>1)
                                {
                                @for($i=0;$i<$no_of_people;$i++)

                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingVehicle_traveller_name">
                                        <span class="bar"></span>
                                        <label>Traveller's Name</label>
                                    </div>

                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <textarea type="text" class="form-text" required name="bookingVehicle_age"></textarea>
                                        <span class="bar"></span>
                                        <label>Traveller's Age</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <textarea type="text" class="form-text" required name="bookingVehicle_phone_no"></textarea>
                                        <span class="bar"></span>
                                        <label>Traveller's Contact No.</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingVehicle_address">
                                        <span class="bar"></span>
                                        <label>Traveller's Address</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingVehicle_email">
                                        <span class="bar"></span>

        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Vehicle Bookings</h3>
                            ...
                            <div class="col-md-12 tabs-area">
                                ...
                                <div class="tab-content tab-content-v5">
                                    <div class="tab-pane fade in" id="tabs-demo6-area4">
                                        @include('Backend.Vehicles.Bookings.search')
                                    </div>
                                    <div class="tab-pane fade in active" id="tabs-demo6-area1">
                                        @include('Backend.Vehicles.Bookings.list')
                                    </div>
                                    <div class="tab-pane fade" id="tabs-demo6-area2">
                                        {{--@include('Backend.Vehicles.Bookings.create')--}}

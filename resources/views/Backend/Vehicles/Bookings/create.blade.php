            ...
            <div class="col-md-12">
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('bookingsVehicle.save')}}">
                            @csrf
                            <input type="hidden" value="{{$vehicle_id}}" name="booking_vehicle_id">
                            <input type="hidden" value="{{$from}}" name="booking_vehicle_from">
                            <input type="hidden" value="{{$to}}" name="booking_vehicle_to">
                            <input type="hidden" value="{{$no_of_People}}" name="booking_vehicle_no_of_People">
                            <input type="hidden" value="{{$start_date}}" name="booking_vehicle_start_date">
                            <input type="hidden" value="{{$end_date}}" name="booking_vehicle_end_date">
                                ...
                                @for($i=0;$i<$no_of_People;$i++)
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                               name="bookingVehicle_traveller_name[]">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                               name="bookingVehicle_traveller_dob[]">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                               name="bookingVehicle_traveller_phone_no[]">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required
                                               name="bookingVehicle_traveller_address[]">
                                        <span class="bar"></span>
                        ...
                        <!-- Booked By -->
                            ...
                            <h2>Booked By :</h2>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required name="bookingVehicle_booking_done_by">
                                <span class="bar"></span>
                                <label>Name:</label>
                            </div>
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                <input type="text" class="form-text" required
                                       name="bookingVehicle_phone_no">
                                <span class="bar"></span>

        ...
        <div class="col-md-12 col-sm-12 profile-v1-wrapper">
            <div class="col-md-9  profile-v1-cover-wrap" style="padding-right:0px;">
                <div class="profile-v1-pp">
                    <img src="{{URL::to('storage/app/public/'.$tour->image)}}" class="img-responsive"/>
                    <h2>{{$tour->name}}</h2>
                        ...
                        <div class="col-md-12 padding-0 box-v7-header">
                            <div class="col-md-12 padding-0">
                                <div class="col-md-10 padding-0">
                                    <img src="{{URL::to('storage/app/public/'.$tour->image)}}" class="img-responsive box-v7-avatar pull-left"/>
                                    <h4>{{$tour->name}}</h4>

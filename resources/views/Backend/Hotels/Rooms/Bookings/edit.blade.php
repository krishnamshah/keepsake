            ...
            <div class="col-md-12">
                ...
                <div class="form-element">
                    <div class="col-md-12 padding-0">
                        <form method="post" enctype="multipart/form-data" action="{{route('bookingsRoom.update',$booking->id)}}">
                            @csrf
                            @php
                                $no_of_people->bookingRoom();
                            @endphp
                            @if($no_of_people>1)
                                {
                                @for($i=0;$i<$no_of_people;$i++)
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_traveller_name"  value="{{$booking->name}}">
                                        <span class="bar"></span>
                                    ...
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_dob" value="{{$booking->dob}}">
                                        <span class="bar"></span>
                                        <label>Traveller's Date of Birth</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_phone_no" value="{{$booking->phone_no}}">
                                        <label>Traveller's Contact No.</label>
                                    </div>
                                    <div class="form-group form-animate-text" style="margin-top:40px !important;">
                                        <input type="text" class="form-text" required name="bookingTour_address" value="{{$booking->address}}">
                                        <span class="bar"></span>

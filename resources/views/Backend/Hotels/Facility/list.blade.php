        ...
        @forelse($facilities as $facility)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{route('hotels.facilities.edit',$facility->id)}}" ><span class="label label-warning">Edit</span></a>
                    <a href="{{route((($facility->enable==1)?'hotels.facilities.deactivate':'hotels.facilites.activate'),$facility->id)}}">

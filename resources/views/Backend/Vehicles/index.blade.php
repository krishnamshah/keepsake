        ...
        <div class="tabs-wrapper text-center">
            <div class="panel box-shadow-none text-left content-header">
                <div class="panel-body" style="padding-bottom:0px;">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Vehicle rental services</h3>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12 tabs-area">
                                ...
                                <ul class="nav nav-tabs nav-tabs-v5" id="tabs-demo6">
                                    <li class="active">Vehicles
                                        <a href="#tabs-demo6-area1" data-toggle="tab" title="Vehicles">
                          <span class="round-tabs one">
                            <i class="glyphicon glyphicon-plane"></i>
                                    ...
                                    <li>Add New Vehicle
                                        <a href="#tabs-demo6-area2" data-toggle="tab" title="Add New Vehicle">
                                            <span class="round-tabs two"><i class="glyphicon glyphicon-user"></i></span>
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content tab-content-v5">
                                    <div class="tab-pane fade in active" id="tabs-demo6-area1">
                                        @include('Backend.Vehicles.list')
                                    </div>
                                    <div class="tab-pane fade" id="tabs-demo6-area2">
                                        @include('Backend.Vehicles.create')

                                    </div>
                                    <div class="tab-pane fade" id="tabs-demo6-area3">
                                        @include('Backend.Vehicles.search')
